  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Button variant="outline" size="icon" onClick={onPrev} disabled={step === 0} aria-label="Passo anterior">
          <SkipBack className="size-4" />
        </Button>
        <Button onClick={onPlayToggle} className="min-w-24" aria-label={playing ? "Pausar" : "Reproduzir"}>
